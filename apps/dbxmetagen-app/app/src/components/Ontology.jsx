  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-4">
        ...
        <span className="relative group cursor-help" title="Each bundle defines its own entity IDs. Entities from different bundles will not unify -- use the same bundle across all data for consistent entity linkage.">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-slate-400 group-hover:text-slate-600 dark:group-hover:text-slate-300 transition-colors" viewBox="0 0 20 20" fill="currentColor">
