...
Two strategies:
  ...
  - Pattern: for curated/imported bundles (healthcare, financial_services, etc.).
...
from the canonical registry. Pure logic only (no file IO) so it can be reused by
the app importer and the build scripts.
"""
...
# ===================================================================
# Pattern strategy: curated / imported bundles
# ===================================================================
