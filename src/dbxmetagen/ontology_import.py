    ...
    for prop in g.subjects(RDF.type, OWL.ObjectProperty):
        ...
        for domain_cls in domains:
            if domain_cls in entities:
                ...
                # Object-property entries are meaningful (not naive "dimension");
                # process_bundle preserves them. Pattern-strategy generation only
                # iterates typical_attributes, so it cannot reconstruct these.
